...
lua_la_DEPENDENCIES = $(srcdir)/3rd/lua-5.3.4/liblua.a
am__lua_la_SOURCES_DIST = plugin-wrapper.c 3rd/jsmn/jsmn.c \
	array-wrapper.c json-wrapper.c lua-api.c db-wrapper.c
am__dirstamp = $(am__leading_dot)dirstamp
am__objects_1 = db-wrapper.lo
am_lua_la_OBJECTS = plugin-wrapper.lo 3rd/jsmn/jsmn.lo \
	array-wrapper.lo json-wrapper.lo lua-api.lo $(am__objects_1)
...
am__v_CCLD_1 = 
SOURCES = $(lua_la_SOURCES)
DIST_SOURCES = $(am__lua_la_SOURCES_DIST)
...
STRIP = strip
VERSION = 0.5.2b
abs_builddir = /home/mrsang/build/antd-lua-plugin
abs_srcdir = /home/mrsang/build/antd-lua-plugin
...
#AM_CPPFLAGS = -Wl,-undefined,dynamic_lookup -W -Wall -g \
#	-std=c99 -fPIC

# check for system
AM_CPPFLAGS = -Wl,--no-as-needed -W -Wall -g -std=c99 \
	-fPIC
#FL_LUA = macosx
FL_LUA = linux
# main plugin
...
lua_la_SOURCES = plugin-wrapper.c 3rd/jsmn/jsmn.c array-wrapper.c \
	json-wrapper.c lua-api.c $(am__append_1)
...
3rd/jsmn/$(am__dirstamp):
	@$(MKDIR_P) 3rd/jsmn
	@: > 3rd/jsmn/$(am__dirstamp)
3rd/jsmn/$(DEPDIR)/$(am__dirstamp):
	@$(MKDIR_P) 3rd/jsmn/$(DEPDIR)
	@: > 3rd/jsmn/$(DEPDIR)/$(am__dirstamp)
3rd/jsmn/jsmn.lo: 3rd/jsmn/$(am__dirstamp) \
	3rd/jsmn/$(DEPDIR)/$(am__dirstamp)
...
mostlyclean-compile:
	-rm -f *.$(OBJEXT)
	-rm -f 3rd/jsmn/*.$(OBJEXT)
	-rm -f 3rd/jsmn/*.lo

distclean-compile:
	-rm -f *.tab.c

include ./$(DEPDIR)/array-wrapper.Plo
include ./$(DEPDIR)/db-wrapper.Plo
include ./$(DEPDIR)/json-wrapper.Plo
include ./$(DEPDIR)/lua-api.Plo
include ./$(DEPDIR)/plugin-wrapper.Plo
include 3rd/jsmn/$(DEPDIR)/jsmn.Plo
...
clean-libtool:
	-rm -rf .libs _libs
	-rm -rf 3rd/jsmn/.libs 3rd/jsmn/_libs
...
distclean-generic:
	...
	-rm -f 3rd/jsmn/$(DEPDIR)/$(am__dirstamp)
	-rm -f 3rd/jsmn/$(am__dirstamp)
